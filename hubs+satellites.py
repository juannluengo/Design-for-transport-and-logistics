...
obj_B = (
    ...
    gp.quicksum((dist_satellitesA_hubA[j, i] / Vt) * deltaT * h_A[i] * zk_A[j] for i in range(num_hubs_per_cluster * k_optimal_districtA) for j in range(num_satellites_per_cluster * k_optimal_districtA)) +
    gp.quicksum((dist_satellitesA_deliveriesA[i, j] / Vb) * deltaT * zk_A[i] for i in range(num_satellites_per_cluster * k_optimal_districtA) for j in range(num_customers_per_district)) 
)
